...
function BookRegister() {
  ...
  const handleSubmit = (event) => {
    ...
    if(Object.keys(errors).length === 0){
      axios.post('http://localhost:3001/db_rr', values)
      .then(res => {
        if(res.data === "Sucesso!") {
          navigate('/');
        }else{
          alert("Erro ao registrar o livro.");
        }
      })
          ...
          <div className="container-div">
            ...
            <div className="bookPhoto">
              ...
              <div className="form-field" id="image-upload-container">
                <label htmlFor="file-input" className="upload-label">
                  <input type="file" id="file-input" accept="image/*" className="file-input" name="book_img" ref={fileInputRef} onChange={handleFileChange} />
            ...
            <div className="bookData">
              ...
              <div className="form-field">
                ...
                <input type="text" id="book_gender" name="book_gender" onChange={handleInput} />
            ...
            <div className="bookDetail">
              ...
              <div className="small-fields">
                ...
                <div className="form-field">
                  ...
                  <input type="text" id="book_score" name="book_score" onChange={handleInput}/>
